...
describe('Login Testing with Before Each', () => {

    beforeEach(() => { //Loop auth register in every test case
      cy.visit(Cypress.env("baseUrl-1")) //The Environment Variable guide explains the other ways you can set them outside of your tests
    })
